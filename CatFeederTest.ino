      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // client.print("Click <a href=\"/A\">here</a> AUG<br>");
            // client.print("Click <a href=\"/O\">here</a> Open Door<br>");
            // client.print("Click <a href=\"/C\">here</a> Close Door<br>");
        ...
        if (currentLine.endsWith("GET /C")) {
          closeDoor();     // GET /L turns the LED off
        }
      }
